...
> **DSQL 版本**：1.4（2026-09-07，新增 TOTAL 聚合与 $变量$ 派生体系） · 实现：`src/query/lexer.ts` · `parser.ts` · `executor.ts`
...
- **v1.2 修订 3（2026-09-07）**：
  ...
  - `**WITHOUT** **ID**` 可写在任意子句位置。
- **v1.3（2026-09-07，测试修订 1.3.001，当前）**：
...
- **v1.4（2026-09-07，当前）**：新增 **TOTAL 全表聚合与 $变量$ 派生体系**：
